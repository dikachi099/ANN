...
public class Momentum {
    ...
    public Momentum(int hiddenNodesNum, int outputNodeNum, int inputNodeNum) {
    ...
    public double updateWeightsandBias(double[] inputs) {
        ...
        for (int i = 0; i < hiddenNodesNum; i++) {
            for (int j = 0; j < inputNodeNum; j++) {
                ...
                double deltaWeight = 0.1 * hiddenNodeDeltaArray[i] * inputs[j]; // Calculate weight change
...
//            System.out.println(prevHiddenWeight);
            double deltaHiddenWeight = 0.1 * outputNodeDelta * hiddenNodeSig[i]; // Calculate weight change
            ...
            hiddenLayerBias[i] += 0.1 * hiddenNodeDeltaArray[i] * 1; // Update bias
            // Apply momentum term
...
//        System.out.println(prevOutputNodeBias);
        outputNodeBias += 0.1 * outputNodeDelta * 1; // Update bias
        // Apply momentum term
